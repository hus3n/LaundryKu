    ...
    <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-white/90 dark:bg-[#010E1C]/85 border-b border-slate-200 dark:border-[#1DA9D0]/15 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs font-semibold text-slate-600 dark:text-[#F5EACA]/75">
          <a href="#fitur-inti" className="hover:text-[#1DA9D0] dark:hover:text-[#43D5CC] transition-colors">
            Fitur Inti
          </a>
          <a href="#alur-pos" className="hover:text-[#1DA9D0] dark:hover:text-[#43D5CC] transition-colors">
            Alur Kerja
          </a>
          <a href="#simulasi-roi" className="hover:text-[#1DA9D0] dark:hover:text-[#43D5CC] transition-colors">
            Simulasi ROI
          </a>
          <Link href="/komparasi" className="hover:text-[#1DA9D0] dark:hover:text-[#43D5CC] transition-colors">
            Komparasi
          </Link>
