      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-20 w-full relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="glass-card-dark p-8 rounded-3xl border border-[#1DA9D0]/15 flex flex-col items-center text-center space-y-4 hover:border-[#1DA9D0]/30 transition-colors group">
            ...
            <div>
              <h3 className="font-bold text-foreground mb-1">Live Chat WhatsApp</h3>
              <p className="text-xs text-foreground/60 mb-3">Prioritas bantuan, setup & migrasi (Senin-Minggu, Jam Kerja Utama 08.00-21.00).</p>
          ...
          <div className="glass-card-dark p-8 rounded-3xl border border-[#1DA9D0]/15 flex flex-col items-center text-center space-y-4 hover:border-[#1DA9D0]/30 transition-colors group">
            ...
            <div>
              ...
              <p className="text-xs text-foreground/60 mb-3">Penawaran kerjasama B2B korporat atau saran kritik teknikal.</p>
          ...
          <div className="glass-card-dark p-8 rounded-3xl border border-[#1DA9D0]/15 flex flex-col items-center text-center space-y-4 hover:border-[#1DA9D0]/30 transition-colors group">
            ...
            <div>
              <h3 className="font-bold text-foreground mb-1">Markas Pengembangan</h3>
              <p className="text-xs text-foreground/60 mb-3">Dioperasikan sepenuh hati dari Indonesia secara Cloud Computing.</p>
