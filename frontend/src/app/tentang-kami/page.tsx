    ...
    <div className="min-h-screen bg-[#010E1C] text-[#F5EACA] flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20 w-full relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[#F5EACA]">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          <div className="glass-card-dark p-8 rounded-3xl border border-[#1DA9D0]/15">
            <h3 className="text-xl font-bold text-[#F5EACA] mb-4">Latar Belakang</h3>
            <p className="text-sm text-[#F5EACA]/70 leading-relaxed mb-4">
          ...
          <div className="glass-card-dark p-8 rounded-3xl border border-[#1DA9D0]/30 shadow-2xl shadow-[#1DA9D0]/10 bg-gradient-to-tr from-[#012040] to-transparent">
            <h3 className="text-xl font-bold text-[#F5EACA] mb-4">Misi LaundryKu</h3>
            <ul className="space-y-4 text-sm text-[#F5EACA]/80">
