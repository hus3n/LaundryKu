    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-20 w-full relative z-10">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-foreground">Syarat dan Ketentuan (Terms of Service)</h1>
        </div>
        ...
        <div className="glass-card-dark p-8 md:p-10 rounded-3xl border border-[#1DA9D0]/15 relative prose prose-invert max-w-none text-sm text-foreground/70 leading-relaxed">
          <h2 className="text-xl font-bold text-foreground mb-4 mt-8">1. Penggunaan Layanan Secara Umum</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold text-foreground mb-4 mt-8">2. Kebijakan SLA (Service Level Agreement)</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold text-foreground mb-4 mt-8">3. Akun dan Tanggung Jawab Pengguna</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-bold text-foreground mb-4 mt-8">4. Pembayaran, Upgrade & Refund</h2>
          <p className="mb-4">
