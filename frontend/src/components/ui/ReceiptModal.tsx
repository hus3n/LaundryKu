        ...
        <div className="bg-white text-slate-900 rounded-3xl p-6 max-w-sm w-full shadow-2xl relative space-y-4 pointer-events-auto print:p-0 print:shadow-none print:w-full print:rounded-none">
          ...
          <div id="receipt-print-area" className="font-mono text-[11px] space-y-3 leading-tight text-slate-800">
            ...
            <div style={{
              ...
              {store?.storeLogo ? (
                <img
                  src={store.storeLogo.startsWith('http') ? store.storeLogo : `/${store.storeLogo.replace(/^\//, '')}`}
          ...
          <div className="flex gap-3 pt-2 print:hidden">
            ...
            <motion.button
              whileTap={{ scale: 0.95 }}
              onClick={handlePrint}
              className="flex-1 py-2.5 rounded-xl bg-[#1DA9D0] dark:bg-gradient-to-r dark:from-[#1DA9D0] dark:to-[#43D5CC] text-[#010E1C] font-bold text-xs shadow-lg transition-colors flex items-center justify-center gap-2"
            >
